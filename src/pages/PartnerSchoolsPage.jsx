  ...
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        'SckoolChess is the trusted chess partner for 12+ leading schools in Delhi, Noida & Navi Mumbai. NEP-aligned chess in school programs for every student.'
      )
    }
  }, [])
      ...
      <section className="partner-hero-section">
        ...
        <div className="partner-hero-header-row">
          ...
          <div className="partner-hero-socials">
            <a href="https://www.linkedin.com/company/sckoolchess/" target="_blank" rel="noopener noreferrer" className="partner-social-link" title="LinkedIn">
              <img src="/linkedinlogo.png" alt="LinkedIn" style={{ width: '24px', height: '24px', objectFit: 'contain' }} />
            </a>
            <a href="https://www.instagram.com/sckoolchess?igsh=bzMwaTB0YWw2d2Iz" target="_blank" rel="noopener noreferrer" className="partner-social-link" title="Instagram">
              <img src="/instagramlogo.png" alt="Instagram" style={{ width: '24px', height: '24px', objectFit: 'contain' }} />
            </a>
          </div>
        </div>
