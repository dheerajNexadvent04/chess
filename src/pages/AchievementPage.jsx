  ...
  return (
    <div className="achievement-page">
      ...
      <section className="achievement-hero-banner">
        ...
        />
        <div className="achievement-hero-overlay" />
        <div className="achievement-hero-content">
          <p className="achievement-hero-kicker">Our Achievements</p>
          <h1 className="achievement-hero-title">
            Achievements That <span className="achievement-hero-highlight">Build Champions</span>
          </h1>
          <p className="achievement-hero-sub">
            Celebrating tournaments, milestones, and the journey of every young chess player.
          </p>
